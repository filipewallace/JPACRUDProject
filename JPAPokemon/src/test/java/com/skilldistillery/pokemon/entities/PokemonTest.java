...
class PokemonTest {
	...
	@Test
	@DisplayName("test pokemon entity mapped")
	void test() {
		assertNotNull(pokemon);
		assertEquals("Eevee", pokemon.getName());
		assertEquals("Normal", pokemon.getType());
		assertEquals("Fighting", pokemon.getWeakness());
		assertEquals("Sylveon", pokemon.getEvolvedName());
	}
